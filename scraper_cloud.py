...
async def login(page):
    ...
    try:
        ...
        await email_input.fill(DELIVEROO_EMAIL)
    ...
    try:
        ...
        await pw_input.fill(DELIVEROO_PASSWORD)
    ...
    # Click the Log in submit button (not cookie banner buttons)
    try:
        login_btn = page.locator('form button[type="submit"]').first
        if not await login_btn.is_visible(timeout=2000):
